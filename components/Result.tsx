...
const Result = (props: Props) => (
  <div className="mx-auto lg:mx-0 mt-8 lg:mt-0 w-56 lg:w-64 rounded-lg bg-white border border-solid border-gray-200">
    <div className="rounded-t-lg py-5 bg-gray-600 border-b border-solid border-gray-200">
    ...
    <div className="bg-gray-50 flex justify-between text-center">
      <span className="ml-2">Keystrokes </span>
      <span className="mr-4">
        (<span className="text-gray-600">{props.correctKeystroke}</span> |{" "}
    ...
    <div className="flex justify-between bg-gray-50">
      ...
      <span className="font-bold text-gray-600 mr-4">{props.correctWords}</span>
    </div>
    <div className="flex justify-between">
