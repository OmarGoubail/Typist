...
const Records = (props: Props) => {
  ...
  if (props.records.length === 0) {
    ...
    props.records.forEach((record, index) => {
      switch (index) {
        case 0:
          firstRecord = (
            <Podium record={record} height={maxHeight} color="bg-gray-400" />
          );
          break;
        case 1:
          secondRecord = (
  ...
  return (
    <div className="mx-auto w-56 lg:w-64">
      <div className="p-4 mt-8 lg:mt-16 bg-white border border-gray-300 border-solid rounded-lg text-center">
